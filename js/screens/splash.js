...
SplashScreen.prototype.show = function() {	 
	...
	this.playBtn =  this.splashScreenSprites.create(320, 600, 'playBtnTexture');
	this.playBtn.inputEnabled = true;
	this.playBtn.events.onInputDown.add(this.hide, this);
	this.instructionsBtn =  this.splashScreenSprites.create(520, 600, 'instructionsBtnTexture');
